...
La versión de referencia actual es `v1.0.3`. El puente nativo se compila por defecto desde `v1.0.1`.
...
5. Usar un título coherente, por ejemplo `AirPods Companion v1.0.3 (Edición única)`.
